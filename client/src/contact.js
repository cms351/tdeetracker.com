      ...
      <div className="w3-main" id="main">
        ...
        <div className="w3-row w3-padding-64">
          ...
          <div className="w3-container">
            <h1 className="w3-text-teal">About the Developer</h1>
            <p>
          ...
          <div className="w3-third">
            ...
            <div className="w3-white w3-text-grey w3-card-4">
              <div className="w3-container">
                ...
                <p><i className="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>Austin, TX</p>
                <p><i className="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>cms351@txstate.edu</p>
                <p><i className="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>Email for phone number</p>
                <hr/>
                ...
                <p className="w3-large w3-text-theme"><b><i className="fa fa-suitcase fa-fw w3-margin-right w3-text-teal"></i>Employment History</b></p>
                <h4><b>Student Worker</b></h4>
                <h6><i>Texas State University</i></h6>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>May 2020 - May 2021</h6>
                <div className="w3-light-grey w3-round-xlarge">
                  <div className="w3-round-xlarge w3-teal"></div>
                </div>
                <h4><b>Lead Cook</b></h4>
                <h6><i>Mama Fu's Asian House</i></h6>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>January 2020 - March 2020</h6>
                <div className="w3-light-grey w3-round-xlarge">
                  <div className="w3-round-xlarge w3-teal"></div>
                </div>
                <h4><b>Fry Cook</b></h4>
                <h6><i>Saltgrass Steakhouse</i></h6>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>April 2019 - December 2019</h6>
                <div className="w3-light-grey w3-round-xlarge">
                  <div className="w3-round-xlarge w3-teal"></div>
                </div>
                <h4><b>Lead Cook</b></h4>
                <h6><i>Delicious Garden New Braunfels</i></h6>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>December 2017 - April 2019</h6>
                <div className="w3-light-grey w3-round-xlarge">
                  <div className="w3-round-xlarge w3-teal"></div>
                </div>
                <br/>
          ...
          <div className="w3-twothird">
            ...
            <h2 className="w3-text-grey w3-padding-16"><i className="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education</h2>
              <div className="w3-container">
                <h5 className="w3-opacity"><b>Texas State University</b></h5>
                <h6><i>Bachelor's in Computer Science</i></h6>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>August 2017 - May 2022</h6>
            ...
            <div className="w3-container w3-card w3-white w3-margin-bottom">
              <h2 className="w3-text-grey w3-padding-16"><i className="fa fa-globe fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Projects</h2>
              <div className="w3-container">
                <h5 className="w3-opacity"><b>TDEETracker.com</b></h5>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>July 2021 - February 2022</h6>
              ...
              <div className="w3-container">
                <h5 className="w3-opacity"><b>Mandelbrot Fractal Zoomer</b></h5>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>July 2021 - August 2021</h6>
              ...
              <div className="w3-container">
                <h5 className="w3-opacity"><b>Linux Function Implementation</b></h5>
                <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>May 2021 - July 2021</h6>
